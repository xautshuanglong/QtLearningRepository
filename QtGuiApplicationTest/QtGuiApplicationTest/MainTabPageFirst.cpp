    ...
    , mpCurEnteredItem(Q_NULLPTR)
{
    ...
    //ui.listContainer->setStyleSheet("background-color: green;");
...
void MainTabPageFirst::resizeEvent(QResizeEvent *event)
{
    QRect listContainerRect = ui.listContainer->geometry();
    ui.lvAppList->move(0, 0);
    ui.lvAppList->resize(ui.listContainer->size());
    ui.lwAppList->move(0, 0);
