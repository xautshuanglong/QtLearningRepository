    ...
    , mpFramelessWindow(Q_NULLPTR)
{
    ...
    DebugPanel::GetInstance()->AddDebugInfoWidget(QString::fromLocal8Bit("测试项"), mpCpuUsageWidget);
    ...
    mpTrayActionShow = new QAction(QStringLiteral("显示"));
    mpTrayActionExit = new QAction(QStringLiteral("退出"));
