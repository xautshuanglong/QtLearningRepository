...
struct VertexPosNormalColor
{
    ...
    constexpr VertexPosNormalColor(
        const DirectX::XMFLOAT3& _pos,
...
struct VertexPosNormalTangentTex
{
    ...
    constexpr VertexPosNormalTangentTex(
        const DirectX::XMFLOAT3& _pos,
        const DirectX::XMFLOAT3& _normal,
